...
export class updateLengthFields1673299235693 implements MigrationInterface {
    name = 'updateLengthFields1673299235693'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "restoreCodes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying(6) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "expiresAt" TIMESTAMP NOT NULL, "hasUsed" boolean NOT NULL DEFAULT false, "issuerId" uuid, CONSTRAINT "PK_cc9da4eb50d398eef4839ed66fb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "vehicles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "sellType" character varying(12) NOT NULL DEFAULT 'VENDA', "title" character varying(150) NOT NULL, "description" character varying(500) NOT NULL, "year" character varying(4) NOT NULL, "km" integer NOT NULL, "price" integer NOT NULL, "type" character varying(12) NOT NULL, "isPublished" boolean NOT NULL DEFAULT false, "capeImage" character varying(200) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "ownerId" uuid, CONSTRAINT "PK_18d8646b59304dce4af3a9e35b6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(120) NOT NULL, "email" character varying(120) NOT NULL, "cpf" character varying(14) NOT NULL, "phone" character varying(15) NOT NULL, "birthDate" TIMESTAMP NOT NULL, "biography" character varying(300) NOT NULL, "accountType" character varying(12) NOT NULL DEFAULT 'COMPRADOR', "password" character varying(150) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "addressId" uuid, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "addresses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cep" character varying(9) NOT NULL, "state" character varying(2) NOT NULL, "city" character varying(30) NOT NULL, "street" character varying(80) NOT NULL, "number" character varying(5) NOT NULL, "complement" character varying(60) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
